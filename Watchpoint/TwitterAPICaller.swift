...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "Km04eBKz0e1Pmv4S45hAT2brG", consumerSecret: "jYNqimP736t4BGjN09y2g20ndiIbNOKpIrJ13K5DE2HKP4rniv")
    var loginSuccess: (() -> ())?
